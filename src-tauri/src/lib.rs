...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::list_voice_subtitle_cues,
            ...
            commands::create_cloud_voice_profile,
            commands::list_cloud_voices,
            commands::link_cloud_voice_profile,
            commands::delete_cloud_voice_remote,
            commands::refresh_cloud_voice_status,
            commands::retrain_cloud_voice_profile,
            ...
            commands::list_subtitle_style_presets,
            commands::save_subtitle_style_preset,
            commands::delete_subtitle_style_preset,
            commands::reorder_subtitle_style_presets,
